    ...
    <div className="py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className={`text-xl mb-6 ${isDark ? 'text-white' : 'text-gray-600'}`}>
            {project.description}
          </p>

          <div className="flex flex-wrap gap-2 mb-6">
            {project.tech.map((t) => (
              <span key={`detail-${t}`} className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full">
                {t}
              </span>
            ))}
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <ul className={`list-disc list-inside mb-6 space-y-2 ${isDark ? 'text-white' : 'text-gray-600'}`}>
            ...
            <p className={isDark ? 'text-white' : 'text-gray-600'}>
              Built with {project.tech.join(', ')}, this project follows industry best practices for
